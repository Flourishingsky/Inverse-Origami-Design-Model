...
%   此处显示详细说明
    ...
    plot3([facet1_x(4),facet1_x(3)],[facet1_y(4),facet1_y(3)],[facet1_z(4),facet1_z(3)],'r','Linewidth',1);hold on;
    plot3([facet1_x(3),facet1_x(2)],[facet1_y(3),facet1_y(2)],[facet1_z(3),facet1_z(2)],'r','Linewidth',1);hold on;
    plot3([facet1_x(2),facet1_x(1)],[facet1_y(2),facet1_y(1)],[facet1_z(2),facet1_z(1)],'r','Linewidth',1);hold on;
% 
    plot3(2*hs-[facet1_x(1),facet1_x(4)],[facet1_y(1),facet1_y(4)],[facet1_z(1),facet1_z(4)],'b-.','Linewidth',1);hold on;
    plot3(2*hs-[facet1_x(4),facet1_x(3)],[facet1_y(4),facet1_y(3)],[facet1_z(4),facet1_z(3)],'r','Linewidth',1);hold on;
    plot3(2*hs-[facet1_x(3),facet1_x(2)],[facet1_y(3),facet1_y(2)],[facet1_z(3),facet1_z(2)],'r','Linewidth',1);hold on;
    plot3(2*hs-[facet1_x(2),facet1_x(1)],[facet1_y(2),facet1_y(1)],[facet1_z(2),facet1_z(1)],'r','Linewidth',1);hold on;
